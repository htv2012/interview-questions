...
@pytest.mark.parametrize(
    "indata, expected",
    [
        pytest.param("the sky is blue", "blue is sky the", id="example 1"),
        pytest.param("  hello world  ", "world hello", id="example 2"),
        pytest.param("a good   example", "example good a", id="example 3"),
        pytest.param("EPY2giL", "EPY2giL", id="wrong 1"),
    ],
)
