...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("abc", "pqr", "apbqcr", id="example 1"),
        pytest.param("ab", "pqrs", "apbqrs", id="example 2"),
        pytest.param("abcd", "pq", "apbqcd", id="example 3"),
    ],
)
def test_solution(fut, word1, word2, expected):
    assert fut(word1, word2) == expected
